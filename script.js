...
function loadAssets(callback) {
  backgroundImage.src = 'maitreebg.jpeg';
  backgroundImage.onload = function () {
    characterImage1.src = 'mermaid.png'; // Replace with the path to your first character image
    characterImage1.onload = function () {
      characterImage2.src = 'mermaid.png'; // Replace with the path to your second character image
      characterImage2.onload = function () {
        floorImage.src = 'waves.png'; // Replace with the path to your floor tile image
        floorImage.onload = function () {
          explosionImage.src = 'splash.png'; // Replace with the path to your explosion image
...
function detectPlatformCollision() {
  ...
  if (gameOver && player.explosionCounter < 50) { // Change this condition
    const explosionWidth = characterWidth * 4; // Multiply by 2 to make the explosion larger
    const explosionHeight = characterHeight * 4; // Multiply by 2 to make the explosion larger

    ctx.save();
    ctx.translate(-camera.x, 0);
    ctx.drawImage(
      explosionImage,
      player.x - (explosionWidth - characterWidth) / 4, // Center the explosion horizontally
      player.y - (explosionHeight - characterHeight) / 4, // Center the explosion vertically
      explosionWidth,
      explosionHeight
    );
    ctx.restore();
